...
<!--Header-part-->
<div id="header">
  <h1><a href="daftar.php">RM.Cilempay</a></h1>
</div>
<!--close-Header-part--> 
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; RM.Cilempay <a href="#">by 18111046_FaizarNurFatihin_TIFRP18CIDB_UASWEB1</a> </div>
</div>
<!--end-Footer-part--> 
