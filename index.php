...
<body>
	<div class="limiter">
		<div class="container-login100" style="background-image: url('template/masuk/images/pantai.jpg');">
			<div class="wrap-login100 p-t-120 p-b-30">
				<form action="" method="post" class="login100-form validate-form">
					...
					<div class="login100-form-avatar">
						<img src="template/masuk/images/Kerang dara.jpg" alt="AVATAR">
					</div>

					<span class="login100-form-title p-t-20 p-b-45">
						RUMAH MAKAN CILEMPAY
					</span>
